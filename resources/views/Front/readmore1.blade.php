...
<main id="main-container">
    <!-- Hero -->
    <div class="bg-image" style="background-image: url('/image/front10.jpg');">
        <div class="bg-black-op-75">
            <div class="content content-top text-center">
                <div class="py-100">
                    <h1 class="font-w700 text-white mb-10">Sunday Sharing Homeless Ekspedisi Ke 1</h1>
                    <h2 class="h4 font-w400 text-white-op">Area Nginden Kota Surabaya</h2>
                    <div class="font-size-md text-muted">
                        <a class="text-body-bg-dark">Hikmawan</a> &bull; 01 juli 2017
                    </div>
                </div>
            </div>
        </div>
