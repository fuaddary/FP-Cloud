...
<main id="main-container">
    <!-- Hero -->
    <div class="bg-image" style="background-image: url('/image/front3.jpg');">
        <div class="bg-black-op-75">
            <div class="content content-top text-center">
                <div class="py-100">
                    <h1 class="font-w700 text-white mb-10">Sunday Sharing Homeless Ekspedisi Ke 2</h1>
                    <h2 class="h4 font-w400 text-white-op">Area Lempuyangan Kota Surabaya</h2>
                    <div class="font-size-md text-muted">
                        <a class="text-body-bg-dark">Cahya Putra</a> &bull; 05 Juli 2017
                    </div>
                </div>
            </div>
        </div>
